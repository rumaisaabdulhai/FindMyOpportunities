...
public class HomeActivity extends AppCompatActivity {
    ...
    /**
     * This is the onCreate Method for HomeActivity.
     *
     ...
     * been opened, it continues to display the HomeActivity Layout which contains
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.ic_search_nav:
                        Intent i2 = new Intent(HomeActivity.this, OpportunitiesListActivity.class);
                        startActivity(i2);
                        break;

                    // Open ProfileActivity
                    case R.id.ic_profile_nav:
                        Intent i3 = new Intent(HomeActivity.this, ProfileActivity.class);
                        startActivity(i3);
                        break;
                }
